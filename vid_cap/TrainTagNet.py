...
if __name__ == "__main__":
    tf.app.flags.DEFINE_string("ucfcvd", "Files/Scaled_ResNeXt.npy", "path to UCFC-VD features")
    tf.app.flags.DEFINE_string("ucfcvd_tag", "Files/ucfc-vd_tag_gt.npy", "path to UCFC-VD tags")
